...
from app.api.routes import course, detail_course, users, theme, rating_comments, favorites, follower, pull_request, modules, publications, version
...
app.include_router(pull_request.router, prefix="/api/pull-request", tags=["PullRequest"])
app.include_router(modules.router, prefix="/api/modules", tags=["Modules"])
app.include_router(publications.router, prefix="/api/publications", tags=["Publications"])
app.include_router(version.router, prefix="/api/versions", tags=["Versions"])